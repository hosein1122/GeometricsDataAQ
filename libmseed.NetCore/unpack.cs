...
//        static int unpackheaderbyteorder = -2;
//        static int unpackdatabyteorder = -2;

//        /* Data encoding format/fallback controlled by environment variable */
//        /* -2 = not checked, -1 = checked but not set, or = encoding */
//        static int unpackencodingformat = -2;
//        static int unpackencodingfallback = -2;
...
//        private int msr_unpack(ref string record, int reclen, MSRecord[] ppmsr, flag dataflag, flag verbose)
//        {
...
//            MSRecord msr = null;
//            string sequence_number = new string(new char[7]);
//            string srcname = new string(new char[50]);

//            /* For blockette parsing */
//            BlktLink blkt_link = null;
//            ushort blkt_type;
//            ushort next_blkt;
//            uint blkt_offset;
//            uint blkt_length;
...
//            if (unpackheaderbyteorder == -2 || unpackdatabyteorder == -2 || unpackencodingformat == -2 || unpackencodingfallback == -2)
//            {
...
//            msr.fsdh = realloc(msr.fsdh, sizeof(fsdh_s));
...
//            memcpy(msr.fsdh, record, sizeof(fsdh_s));
...
//                gswap.ms_gswap2a(ref msr.fsdh.numsamples);
//                gswap.ms_gswap2a(ref msr.fsdh.samprate_fact);
//                gswap.ms_gswap2a(ref msr.fsdh.samprate_mult);
//                gswap.ms_gswap4a(ref msr.fsdh.time_correct);
//                gswap.ms_gswap2a(ref msr.fsdh.data_offset);
//                gswap.ms_gswap2a(ref msr.fsdh.blockette_offset);
//            }

//            /* Populate some of the common header fields */
//            sequence_number = msr.fsdh.sequence_number.Substring(0, 6);
//            sequence_number[6] = '\0';
//            msr.sequence_number = (int)strtol(sequence_number, null, 10);
...
//            while ((blkt_offset != 0) && ((int)blkt_offset < reclen) && (blkt_offset < MAXRECLEN))
//            {
...
//                blkt_length = ms_blktlen(blkt_type, record + blkt_offset - 4, headerswapflag);
...
//                    blkt_link = msr_addblockette(msr, record + blkt_offset, sizeof(blkt_100_s), blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_100 = (blkt_100_s)blkt_link.blktdata;
//                    if (headerswapflag)
//                    {
...
//                    blkt_link = msr_addblockette(msr, record + blkt_offset, sizeof(blkt_200_s), blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_200 = (blkt_200_s)blkt_link.blktdata;
...
//                    blkt_link = msr_addblockette(msr, record + blkt_offset, sizeof(blkt_201_s), blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_201 = (blkt_201_s)blkt_link.blktdata;
...
//                    blkt_link = msr_addblockette(msr, record + blkt_offset, sizeof(blkt_300_s), blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_300 = (blkt_300_s)blkt_link.blktdata;
...
//                    blkt_link = msr_addblockette(msr, record + blkt_offset, sizeof(blkt_310_s), blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_310 = (blkt_310_s)blkt_link.blktdata;
//                    if (headerswapflag)
//                    {
...
//                    blkt_link = msr_addblockette(msr, record + blkt_offset, sizeof(blkt_320_s), blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_320 = (blkt_320_s)blkt_link.blktdata;
...
//                    blkt_link = msr_addblockette(msr, record + blkt_offset, sizeof(blkt_390_s), blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_390 = (blkt_390_s)blkt_link.blktdata;
...
//                    blkt_link = msr_addblockette(msr, record + blkt_offset, sizeof(blkt_395_s), blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_395 = (blkt_395_s)blkt_link.blktdata;
...
//                    blkt_link = msr_addblockette(msr, record + blkt_offset, sizeof(blkt_400_s), blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_400 = (blkt_400_s)blkt_link.blktdata;
...
//                    blkt_link = msr_addblockette(msr, record + blkt_offset, sizeof(blkt_405_s), blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_405 = (blkt_405_s)blkt_link.blktdata;
...
//                    blkt_link = msr_addblockette(msr, record + blkt_offset, sizeof(blkt_500_s), blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_500 = (blkt_500_s)blkt_link.blktdata;
...
//                    blkt_1000_s blkt_1000;

//                    blkt_link = msr_addblockette(msr, record + blkt_offset, sizeof(blkt_1000_s), blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_1000 = (blkt_1000_s)blkt_link.blktdata;

//                    /* Calculate record length in bytes as 2^(blkt_1000->reclen) */
//                    msr.reclen = (uint)1 << blkt_1000.reclen;
...
//                    blkt_link = msr_addblockette(msr, record + blkt_offset, sizeof(blkt_1001_s), blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_link = msr_addblockette(msr, record + blkt_offset, b2klen, blkt_type, 0);
//                    if (!blkt_link)
//                    {
//                        break;
//                    }
...
//                    blkt_2000 = (blkt_2000_s)blkt_link.blktdata;
...
//                    if (blkt_length >= 4)
//                    {
//                        blkt_link = msr_addblockette(msr, record + blkt_offset, blkt_length - 4, blkt_type, 0);
...
//                    if (bigendianhost != null && msr.byteorder == 0)
//                    {
//                        dswapflag = 1;
//                    }
...
//         ************************************************************************/
//        private int msr_unpack_data(MSRecord msr, int swapflag, int verbose)
//        {
...
//            if (Environment.GetEnvironmentVariable("DECODE_DEBUG") != null)
//            {
//                decodedebug = 1;
//            }
...
//                    nsamples = unpackdata.msr_decode_int16((short)dbuf, (int)msr.samplecnt, msr.datasamples, unpacksize, swapflag);
...
//                    nsamples = unpackdata.msr_decode_int32((int)dbuf, (int)msr.samplecnt, msr.datasamples, unpacksize, swapflag);
...
//                    nsamples = unpackdata.msr_decode_float32((float)dbuf, (int)msr.samplecnt, msr.datasamples, unpacksize, swapflag);
...
//                    nsamples = unpackdata.msr_decode_float64((double)dbuf, (int)msr.samplecnt, msr.datasamples, unpacksize, swapflag);
...
//                    nsamples = unpackdata.msr_decode_steim1((int)dbuf, datasize, (int)msr.samplecnt, msr.datasamples, unpacksize, srcname, swapflag);
...
//                    nsamples = unpackdata.msr_decode_steim2((int)dbuf, datasize, (int)msr.samplecnt, msr.datasamples, unpacksize, srcname, swapflag);
...
//                    // nsamples = msr_decode_geoscope((string)dbuf, (int)msr.samplecnt, msr.datasamples, unpacksize, msr.encoding, srcname, swapflag);
...
//                    //nsamples = msr_decode_cdsn((short)dbuf, (int)msr.samplecnt, msr.datasamples, unpacksize, swapflag);
...
//                    //nsamples = msr_decode_sro((short)dbuf, (int)msr.samplecnt, msr.datasamples, unpacksize, srcname, swapflag);
...
//                    // nsamples = msr_decode_dwwssn((short)dbuf, (int)msr.samplecnt, msr.datasamples, unpacksize, swapflag);

//                    msr.sampletype = 'i';
//                    break;

//                default:
//                    // ms_log(2, "%s: Unsupported encoding format %d (%s)\n", srcname, msr.encoding, (string)ms_encodingstr(msr.encoding));
...
//            return new return (nsamples);
//        } // End of msr_unpack_data()



//        public static void test_check_environment()
//        {
//            check_environment(1);
//        }
//        /************************************************************************
...
//         ************************************************************************/
//        private static int check_environment(int verbose)
//        {
//            string envvariable;
...
//            {
//                if ((envvariable = Environment.GetEnvironmentVariable("UNPACK_HEADER_BYTEORDER")) != null)
//                {
...
//            {
//                if ((envvariable = Environment.GetEnvironmentVariable("UNPACK_DATA_BYTEORDER")) != null)
//                {
//                    if (envvariable != "0" && envvariable != "1")
//                    {
...
//            {
//                if ((envvariable = Environment.GetEnvironmentVariable("UNPACK_DATA_FORMAT")) != null)
//                {
//                    //unpackencodingformat = (int)strtol(envvariable, null, 10);
//                    unpackencodingformat = Convert.ToInt32(envvariable, 10);// (int)strtol(envvariable, null, 10);
...
//            {
//                if ((envvariable = Environment.GetEnvironmentVariable("UNPACK_DATA_FORMAT_FALLBACK")) != null)
//                {
//                    //unpackencodingfallback = (int)strtol(envvariable, null, 10);
//                    unpackencodingfallback = Convert.ToInt32(envvariable, 10);
